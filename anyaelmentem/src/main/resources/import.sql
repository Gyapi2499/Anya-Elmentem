...
insert into to_dos(id,user,chores,from_date,to_date,group_id)values(1,'anya@anya.com','mosogatas',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),1)
insert into to_dos(id,user,chores,from_date,to_date,group_id)values(2,'apa@apa.com','porszívózás',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),1)
insert into to_dos(id,user,chores,from_date,to_date,group_id)values(3,'bori@bori.com','vasalás',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),1)
insert into to_dos(id,user,chores,from_date,to_date,group_id)values(4,'pisti@pisti.com','ablakpucolás',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),2)
insert into to_dos(id,user,chores,from_date,to_date,group_id)values(5,'pisti@pisti.com','bevásárlás',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),2)
insert into to_dos(id,user,chores,from_date,to_date,group_id)values(6,'bori@bori.com','kutyasétáltatás',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),2)
